...
button_client = Button(root, text='Make tweets', bg="red", font=('times', 32), command=client)
...
button_client.grid(row=1, column=11)
button_check.grid(row= 2, column=11)
button_log.grid(row=3, column=11)
button_quit.grid(row=4, column=11)
